...
void setOledMode(u8 mode)
{
//    oled_mode.oledonoff = (mode >> 7) & 0x01;
//    oled_mode.light = (mode >> 3) & 0x0F;
//    oled_mode.dir = (mode >> 2) & 0x01;
//    oled_mode.oledeffect = (mode >> 0) & 0x03;
    oled_mode._oled_mode = mode;
    oled_mod[0] = (mode >> 7) & 0x01;
    oled_mod[1] = (mode >> 3) & 0x0F;
    oled_mod[2] = (mode >> 2) & 0x01;
    oled_mod[3] = (mode >> 0) & 0x03;
}
